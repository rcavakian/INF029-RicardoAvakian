...
#include "RicardoCamilloAvakian_20221160033.h"
...
void testQ2(){
    ...
    printf("%d\n",dma.retorno == 1);
    printf("%d\n",dma.qtdDias == 4);
    // print para saber quantos dias esta dando o meu programa
    // printf("Dias encontrados na minha logica: %d // Dias que deveria ter encontrado: 4\n",dma.qtdDias);
    printf("%d\n",dma.qtdMeses == 0);
    printf("%d\n",dma.qtdAnos == 1);
    ...
    printf("%d\n",dma.qtdDias == 5);
     // print para saber quantos dias esta dando o meu programa
    // printf("Dias encontrados na minha logica: %d // Dias que deveria ter encontrado: 5\n",dma.qtdDias);
    printf("%d\n",dma.qtdMeses == 0);
    printf("%d\n",dma.qtdAnos == 1);
